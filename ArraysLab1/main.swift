...
var walkingChallenges : [String] = ["walk for 2 miles", "walk for 12 miles", "walk for 20 miles"]
var runningChallenges : [String] = ["run for 4 miles", "run for 80 miles", "run for 100 miles"]
var liftingChallenges : [String] = ["lift for 30 minutes", "lift for 12 hours", "lift for 20 hours"]
...
var commitedChallenges : [String] = ["run for 4 miles", "run for 80 miles", "run for 100 miles"]
print(commitedChallenges)

 
 print("\n")

print("PROBLEM 2.5 : COMBININGgg    IF STATEMENTS AND ARRAYS")
